        ...
        <div id="dialog-role-form" style="display: none;">
            <form id="roleForm">
                <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
                    ...
                    <tr>
                        <td><label for="roleStatus">类型</label></td>
                        <td>
            ...
            $(function () {
                ...
                var setting = {
                    check: {
                        ...
                        chkboxType: {"Y": "ps", "N": "ps"}, // 默认勾选父节点时，子节点也会被勾选
                        autoCheckTrigger: true// 回调方法
                    },
                    data: {
                        simpleData: {
                            enable: true,
                ...
                function recursivePrepareTreeData(aclModuleList) {
                    if (aclModuleList && aclModuleList.length > 0) {
                        $(aclModuleList).each(function(i, aclModule) {
                            ...
                            recursivePrepareTreeData(aclModule.aclModuleLevelDTOList)
                        })
                    }
                }
                ...
                // 添加/修改角色信息（是否为创建角色， 成功的回调方法， 失败的回调方法）
                ...
                $("#roleTab a[data-toggle='tab']").on("shown.bs.tab", function(e) {
                    ...
                    if (e.target.getAttribute("href") == '#roleAclTab') {
                        selectFirstTab = true
                        loadRoleAcl(lastClickRoleId)
                    } else {
                        selectFirstTab = false
                        loadRoleUser(lastClickRoleId)
                    }
                });
